...
void OpdelIBunker() {
  ...
  print(Bunke1[0]);
  image(BBunke1[0], 490, 600, 500/3, 726/3);
  print(Bunke2[0]);
  image(BBunke2[0], 490, 300, 500/3, 726/3);

  image(BagsidenAfKort, 110, 150, 500/3, 726/3);
  image(BagsidenAfKort, 120, 150, 500/3, 726/3);
  image(BagsidenAfKort, 130, 150, 500/3, 726/3);

  image(BagsidenAfKort, 860, 720, 500/3, 726/3);
  image(BagsidenAfKort, 870, 720, 500/3, 726/3);
  image(BagsidenAfKort, 880, 720, 500/3, 726/3);
  
  fill(255,0,0);
  ellipse(160,750,200,200);
  fill(255,0,0);
  ellipse(860,120,200,200);
  image(photo4, 160, 740, 150, 150);
  image(photo1, 860, 120, 200, 200);
}
